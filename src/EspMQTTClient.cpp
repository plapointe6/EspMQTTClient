...
bool EspMQTTClient::connectToMqttBroker()
{
  ...
  bool success = mMqttClient.connect(mMqttClientName, mMqttUsername, mMqttPassword, mMqttLastWillTopic, 0, mMqttLastWillRetain, mMqttLastWillMessage, mMqttCleanSession);
